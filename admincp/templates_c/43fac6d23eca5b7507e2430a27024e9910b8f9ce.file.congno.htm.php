<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-12-03 18:42:23
         compiled from "/usr/local/lib/php/app/adm/templates/congno.htm" */ ?>
<?php /*%%SmartyHeaderCode:1076517075bf786f73064e9-71987875%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1076517075bf786f73064e9-71987875',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5bf786f745a7a9_09058634',
  'variables' => 
  array (
    'paging' => 0,
    'options' => 0,
...
<?php if ($_valid && !is_callable('content_5bf786f745a7a9_09058634')) {function content_5bf786f745a7a9_09058634($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/usr/local/php56/lib/php/app/lib/libs/plugins/function.html_options.php';
if (!is_callable('smarty_modifier_date_format')) include '/usr/local/php56/lib/php/app/lib/libs/plugins/modifier.date_format.php';
...
"><?php echo $_smarty_tpl->tpl_vars['row']->value['fullname'];?>
        ...
        <?php } else { ?>
        <td><a href="index.php?ajax=orders.view&id=<?php echo $_smarty_tpl->tpl_vars['row']->value['oid'];?>
" class="frame"><?php echo $_smarty_tpl->tpl_vars['row']->value['sosim'];?>
</a></td>
        <?php }?>
...
"><?php echo number_format($_smarty_tpl->tpl_vars['row']->value['chiphi']);?>
    ...
    <td class="editable" data-name="congno|phi2|id" data-pk="<?php echo $_smarty_tpl->tpl_vars['row']->value['id'];?>
"><?php echo number_format($_smarty_tpl->tpl_vars['row']->value['phi2']);?>
</td>
        	...
        	<tr>
                ...
                <th class="active"></th>
                     ...
                     <th class="active"><?php echo number_format($_smarty_tpl->tpl_vars['tongphi']->value);?>
                        ...
                        <th class="active"><?php echo number_format($_smarty_tpl->tpl_vars['tongphi2']->value);?>
</th>
